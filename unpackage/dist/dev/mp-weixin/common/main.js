...
/***/ 0:
/*!*****************************************!*\
  !*** O:/AworkTable/乐驾团/TheLjt2/main.js ***!
  \*****************************************/
...
var _nardyWin = _interopRequireDefault(__webpack_require__(/*! @/system/core/nardy.win.js */ 35));
var _nardyDb = _interopRequireDefault(__webpack_require__(/*! @/system/core/nardy.db.js */ 183));
var _uviewUi = _interopRequireDefault(__webpack_require__(/*! @/uni_modules/uview-ui */ 189));
var _vue2 = _interopRequireDefault(__webpack_require__(/*! ./system/vue.plugin */ 311));
var _vuex = _interopRequireDefault(__webpack_require__(/*! ./system/vuex.plugin */ 323));
var _publicUtil = _interopRequireDefault(__webpack_require__(/*! ./util/publicUtil.js */ 356));
...
_vue.default.prototype.$util = _publicUtil.default;
...
createApp(app).$mount();
uni.onMemoryWarning(function (level) {
  if (!level) return;
  // win.toast("检测到系统内存警告！！")
});
...
uni.getNetworkType({
  success: function success(res) {
    _nardyDb.default.set("networkType", res.networkType);
  }
});
uni.onNetworkStatusChange(function (res) {
  if (!res.isConnected) {
    _nardyWin.default.toast("网络连接出错!!");
    return;
  }
  _nardyDb.default.set("networkType", res.networkType);
});
...
/***/ 186:
/*!***************************************************************************!*\
  !*** O:/AworkTable/乐驾团/TheLjt2/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ 27:
/*!*****************************************!*\
  !*** O:/AworkTable/乐驾团/TheLjt2/App.vue ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _App_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&lang=scss& */ 186);
...
/***/ 28:
/*!******************************************************************!*\
  !*** O:/AworkTable/乐驾团/TheLjt2/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _globalData$data$onLa;
var _default = (_globalData$data$onLa = {
  globalData: {
    scene: 'cnm',
    globalBottom: 0,
  ...
  onLaunch: function onLaunch(options) {
    ...
    if (options.query.scene) {
      var arr = options.query.scene.split('_');
      if (arr[0] == 'recomm') {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                (0, _user.login)(params).then(function (res) {
                  if (res && res.code == 0) {
                    _this3.$win.nlog('已登录');
                    var whos = res.resultMap;
                    _this3.$db.setSync('userId', whos.userId);
                    _this3.$db.setSync('token', whos.token);
                    _this3.$db.setSync('identity', whos.identity);
                    if (whos.statu == 0) {
                      console.log('新用户', whos.statu);
                      // this.$win.go('/page_login/index_2?statu=no')
                      _this3.$win.go('/page_login/status/userInfo?new=1');
  ...
  computed: {}
}, (0, _defineProperty2.default)(_globalData$data$onLa, "onShow", function onShow() {}), (0, _defineProperty2.default)(_globalData$data$onLa, "onLoad", function onLoad(e) {
  console.log('rnm', e);
}), _globalData$data$onLa);
