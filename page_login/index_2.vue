		...
		<view class="chooseType">
			...
			<!-- <view class="user">
				...
				<view class="userPhone">
					...
					<button open-type="getPhoneNumber" @getphonenumber="getPhoneNumber">获取微信手机号码</button>
				</view>
			</view> -->

			<button class="save" :disabled="(name=='未选'||myregion=='选择省市')&&userName==null&&userPhone==null" @click="save">{{(statu=='no')?'下一步':'保存'}}</button>
		</view>
